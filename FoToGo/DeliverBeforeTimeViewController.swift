//
//  DeliverBeforeTimeViewController.swift
//  FoToGo
//
//  Created by Shitianyu Pan on 17/01/2017.
//  Copyright © 2017 Doublefinger. All rights reserved.
//

import UIKit

class DeliverBeforeTimeViewController: UIViewController, UINavigationControllerDelegate {
    ...
    func navigationController(_ navigationController: UINavigationController, willShow viewController: UIViewController, animated: Bool) {
        if let controller = viewController as? MakeOrderViewController {
            controller.deliverBeforeTime = expectedTimePicker.date
